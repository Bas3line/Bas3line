...
my public repositories are mirrored on my self-hosted forge at [git.yshubham.com](https://git.yshubham.com/).

most days i'm somewhere around rust, go, python, typescript, zig, swift, linux, postgresql, redis, docker, kubernetes, aws, grafana, and prometheus.
